    ...
    <Layout>
      <div className="container-custom py-20 text-center">
        <div className="max-w-md mx-auto">
          <h1 className="text-6xl font-display font-bold text-sari-terracotta-700 mb-4">404</h1>
          <h2 className="text-3xl font-medium text-sari-terracotta-800 mb-6">Page Not Found</h2>
