    ...
    <section className="py-16 bg-white">
      <div className="container-custom">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-display font-bold text-sari-terracotta-800">Shop by Category</h2>
          ...
          {categories.map((category) => (
            <Link to={category.link} key={category.id} className="group">
              <div className="relative rounded-lg overflow-hidden h-64">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-sari-terracotta-900/70 to-transparent" />
